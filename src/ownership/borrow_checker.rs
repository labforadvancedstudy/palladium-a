...
impl BorrowChecker {
    ...
    /// `crate::ast::local_type_shadows_import` (`src/codegen/mod.rs:2146-2174`)
            ...
            for item in &module_info.ast.items {
                match item {
                    Item::Struct(struct_def) => {
                        ...
                        // imported structs (`src/codegen/mod.rs:2150-2155`), so a
    ...
    pub fn check_program(&mut self, program: &Program) -> Result<()> {
        ...
        // `Item::Enum` (`src/codegen/mod.rs:2146-2174`) and, separately,
        // `Item::Function` (`src/codegen/mod.rs:2306-2307`) — there is no `Item::Impl`
        ...
        for module_name in module_names {
            for item in &modules[module_name].ast.items {
                if let Item::Function(func) = item {
                    ...
                    // (`src/codegen/mod.rs:2307-2310`, public and non-generic) and
