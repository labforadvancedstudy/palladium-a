...
impl CompileError {
    ...
    /// COLLECT (`src/codegen/mod.rs:1908-1912`, `src/codegen/mod.rs:1944-1948`)
    /// and the two that EMIT (`src/codegen/mod.rs:2008-2013`,
    /// `src/codegen/mod.rs:2038-2042`) — so `Result<T, E>` is
