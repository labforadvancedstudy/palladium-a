...
impl CompileError {
    ...
    /// COLLECT (`src/codegen/mod.rs:1998-2002`, `src/codegen/mod.rs:2034-2038`)
    /// and the two that EMIT (`src/codegen/mod.rs:2098-2103`,
    /// `src/codegen/mod.rs:2128-2132`) — so `Result<T, E>` is
