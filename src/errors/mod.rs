...
impl CompileError {
    ...
    /// COLLECT (`src/codegen/mod.rs:1910-1914`, `src/codegen/mod.rs:1946-1950`)
    /// and the two that EMIT (`src/codegen/mod.rs:2010-2015`,
    /// `src/codegen/mod.rs:2040-2044`) — so `Result<T, E>` is
