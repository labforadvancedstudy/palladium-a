...
impl CompileError {
    ...
    /// COLLECT (`src/codegen/mod.rs:1727-1731`, `src/codegen/mod.rs:1763-1767`)
    /// and the two that EMIT (`src/codegen/mod.rs:1827-1832`,
    /// `src/codegen/mod.rs:1857-1861`) — so `Result<T, E>` is
