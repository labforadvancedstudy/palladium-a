...
impl CompileError {
    ...
    /// COLLECT (`src/codegen/mod.rs:1919-1923`, `src/codegen/mod.rs:1955-1959`)
    /// and the two that EMIT (`src/codegen/mod.rs:2019-2024`,
    /// `src/codegen/mod.rs:2049-2053`) — so `Result<T, E>` is
