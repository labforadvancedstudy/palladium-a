...
/// `Expr::span()` returns a dummy for every literal (`src/ast/mod.rs:906-913`),
...
mod tests {
    ...
    fn test_diagnostic_builder_wrong_arg_count_single() {
        ...
        assert!(diag
            .message
            .contains("expects 1 argument, but 0 were provided"));
        ...
        assert!(diag
            .message
            .contains("expects 1 argument, but 2 were provided"));
    ...
    fn test_diagnostic_builder_wrong_arg_count_multiple() {
        ...
        assert!(diag
            .message
            .contains("expects 3 arguments, but 1 were provided"));
        ...
        assert!(diag
            .message
            .contains("expects 2 arguments, but 5 were provided"));
