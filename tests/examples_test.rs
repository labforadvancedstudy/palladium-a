...
fn test_hello_example() {
    ...
    assert!(result.is_ok(), "examples/hello.pd should compile successfully");
}
...
fn test_greet_example() {
    ...
    let result = driver.compile_file(example_path);
    assert!(result.is_ok(), "examples/greet.pd should compile successfully");
}
...
fn test_run_hello_example() {
    ...
    assert!(result.is_ok(), "examples/hello.pd should compile and run successfully");
}