...
/// the two that COLLECT (`src/codegen/mod.rs:2082-2086`,
/// `src/codegen/mod.rs:2118-2122`) and the two that EMIT
/// (`src/codegen/mod.rs:2182-2187`, `src/codegen/mod.rs:2212-2216`) — and
