...
/// the two that COLLECT (`src/codegen/mod.rs:1928-1932`,
/// `src/codegen/mod.rs:1964-1968`) and the two that EMIT
/// (`src/codegen/mod.rs:2028-2033`, `src/codegen/mod.rs:2058-2062`) — and
