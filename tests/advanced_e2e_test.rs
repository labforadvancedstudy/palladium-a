...
#[test]
#[ignore = "XFAIL: function types — grammar.ebnf:172 'No function types'; a parameter declared `f: fn(T) -> U` stops the parser at 'fn' (owned by M4, 'Abstraction')"]
...
#[test]
#[ignore = "XFAIL: struct-variant patterns with field shorthand and `if` guards — grammar.ebnf:263 'No literal patterns, ranges, or-patterns, guards, tuple/slice patterns, ref/mut bindings, @ bindings, field shorthand' (owned by M2, item 4)"]
...
#[test]
#[ignore = "XFAIL: tuple expressions — grammar.ebnf:245 'no tuple expressions'; tuple *types* parse but lower to void* and cannot be constructed (owned by M2, surface syntax)"]
