...
/// (`src/codegen/mod.rs:1294-1306`) and then every local one
...
/// (`src/codegen/mod.rs:1210-1232`) and imported function bodies
/// (`src/codegen/mod.rs:1294-1306`) — from the prototype block
/// (`src/codegen/mod.rs:1765-1780`), which is a fourth site and emits
