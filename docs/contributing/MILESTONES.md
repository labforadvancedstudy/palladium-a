...
`src/typeck/mod.rs:6422-6423` and `src/typeck/mod.rs:6484-6485`. Pinned by
...
M1 fixed the `.await` **consumer** — `src/codegen/mod.rs:6534-6538` returns
