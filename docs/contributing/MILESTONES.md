...
`src/typeck/mod.rs:1518-1518`, the two later codegen walks off their own sorted locals
(`src/codegen/mod.rs:2184-2184`, `src/codegen/mod.rs:3153-3153`), and the instantiation keys at
`src/typeck/mod.rs:6345-6346` and `src/typeck/mod.rs:6407-6408`. Pinned by
...
M1 fixed the `.await` **consumer** — `src/codegen/mod.rs:6490-6494` returns
