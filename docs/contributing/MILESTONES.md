...
`src/typeck/mod.rs:6157-6158` and `src/typeck/mod.rs:6219-6220`. Pinned by
...
M1 fixed the `.await` **consumer** — `src/codegen/mod.rs:6373-6377` returns
