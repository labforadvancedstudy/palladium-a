...
`src/typeck/mod.rs:1502-1502`, the two later codegen walks off their own sorted locals
...
M1 fixed the `.await` **consumer** — `src/codegen/mod.rs:6003-6007` returns
