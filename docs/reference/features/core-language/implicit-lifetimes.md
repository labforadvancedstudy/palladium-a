...
this branch existed. Calls take a per-call lifetime (`src/ownership/borrow_checker.rs:854`) and end
its borrows when the call finishes (`src/ownership/borrow_checker.rs:860`). Five probes are in
