...
(`src/codegen/mod.rs:6428-6432`), and the type checker refuses it before that
(`src/typeck/mod.rs:4824-4824`). `?` is the same shape: refused in codegen
(`src/codegen/mod.rs:6416-6420`) and in the type checker (`src/typeck/mod.rs:4817-4817`).
...
explain why the arms refuse (`src/codegen/mod.rs:6417-6419`, `src/codegen/mod.rs:6429-6431`).
