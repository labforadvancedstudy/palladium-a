...
(`src/parser/mod.rs:733`, `src/parser/mod.rs:744`). The implementation therefore offers exactly the two things this
...
analysis" (`src/parser/mod.rs:970`). An effect analyser exists (`src/effects/mod.rs`, 409 lines;
