...
(`src/parser/mod.rs:615`, `src/parser/mod.rs:626`). The implementation therefore offers exactly the two things this
...
analysis" (`src/parser/mod.rs:852`). An effect analyser exists (`src/effects/mod.rs`, 409 lines;
