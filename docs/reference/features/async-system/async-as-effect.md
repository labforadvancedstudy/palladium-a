...
(`src/codegen/mod.rs:6364-6368`), and the type checker refuses it before that
(`src/typeck/mod.rs:4740-4740`). `?` is the same shape: refused in codegen
(`src/codegen/mod.rs:6352-6356`) and in the type checker (`src/typeck/mod.rs:4733-4733`).
...
explain why the arms refuse (`src/codegen/mod.rs:6353-6355`, `src/codegen/mod.rs:6365-6367`).
