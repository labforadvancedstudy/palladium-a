...
(`src/codegen/mod.rs:6329-6333`), and the type checker refuses it before that
(`src/typeck/mod.rs:4740-4740`). `?` is the same shape: refused in codegen
(`src/codegen/mod.rs:6317-6321`) and in the type checker (`src/typeck/mod.rs:4733-4733`).
...
explain why the arms refuse (`src/codegen/mod.rs:6318-6320`, `src/codegen/mod.rs:6330-6332`).
