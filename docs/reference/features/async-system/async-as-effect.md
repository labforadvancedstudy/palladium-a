...
(`src/codegen/mod.rs:5825-5829`), and the type checker refuses it before that
(`src/typeck/mod.rs:4269-4269`). `?` is the same shape: refused in codegen
(`src/codegen/mod.rs:5813-5817`) and in the type checker (`src/typeck/mod.rs:4262-4262`).
...
explain why the arms refuse (`src/codegen/mod.rs:5814-5816`, `src/codegen/mod.rs:5826-5828`).
