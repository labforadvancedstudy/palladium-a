...
(`src/codegen/mod.rs:6162-6166`), and the type checker refuses it before that
(`src/typeck/mod.rs:4740-4740`). `?` is the same shape: refused in codegen
(`src/codegen/mod.rs:6150-6154`) and in the type checker (`src/typeck/mod.rs:4733-4733`).
...
explain why the arms refuse (`src/codegen/mod.rs:6151-6153`, `src/codegen/mod.rs:6163-6165`).
