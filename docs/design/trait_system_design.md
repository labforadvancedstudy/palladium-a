...
(`src/parser/mod.rs:1218`) and then emit nothing. Codegen ignores `Item::Trait`
(`src/codegen/mod.rs:1024`), the type checker skips trait bodies (`src/typeck/mod.rs:795`), and a
