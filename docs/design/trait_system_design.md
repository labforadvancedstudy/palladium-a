...
(`src/parser/mod.rs:1452`) and then emit nothing. Codegen ignores `Item::Trait`
(`src/codegen/mod.rs:1517-1520`), the type checker skips trait bodies (`src/typeck/mod.rs:1120-1123`), and a
