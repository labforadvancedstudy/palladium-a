...
(`src/parser/mod.rs:1451`) and then emit nothing. Codegen ignores `Item::Trait`
(`src/codegen/mod.rs:1761-1764`), the type checker skips trait bodies (`src/typeck/mod.rs:2155-2158`), and a
