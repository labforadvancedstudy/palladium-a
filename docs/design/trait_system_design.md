...
(`src/parser/mod.rs:1461`) and then emit nothing. Codegen ignores `Item::Trait`
(`src/codegen/mod.rs:1981-1984`), the type checker skips trait bodies (`src/typeck/mod.rs:2198-2201`), and a
