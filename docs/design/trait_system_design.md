...
(`src/parser/mod.rs:1495`) and then emit nothing. Codegen ignores `Item::Trait`
(`src/codegen/mod.rs:2200-2203`), the type checker skips trait bodies (`src/typeck/mod.rs:2574-2577`), and a
